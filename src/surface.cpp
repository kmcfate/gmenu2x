...
{
	Uint32 format;
	SDL_QueryTexture(SDL_GetRenderTarget(Surface::getGlobalRenderer()), &format, nullptr, nullptr, nullptr);
	...
	SDL_SetRenderDrawBlendMode(Surface::getGlobalRenderer(), SDL_BLENDMODE_BLEND);
